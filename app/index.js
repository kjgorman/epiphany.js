...
var app, assets, classData, cls, express, fs, http, idNickPairForClient, io, onlineData, port, srvr, studentsOnline, stylus, _;
...
fs.readFile("class.json", "utf8", function(err, data) {
  if (err) {
