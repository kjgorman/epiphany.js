...
io.of('/student')
  .on 'connection', (socket) ->
    ...
    socket.emit 'class-data', {class_num:1, class_text:"The fibonacci sequence adds the last two numbers in the sequence to find the next, e.g. 0,1,1,2,3,5. Find the 200th number"}
